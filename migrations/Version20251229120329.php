...
/**
 * Class Version20251228162749
 * 
 * The default database schema migration
 * 
 * @package DoctrineMigrations
 */
final class Version20251228162749 extends AbstractMigration
{
    /**
    ...
    {
        $this->addSql('CREATE TABLE articles (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, status VARCHAR(20) NOT NULL, publish_time DATETIME NOT NULL, edited_time DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_BFDD3168989D9B62 (slug), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
